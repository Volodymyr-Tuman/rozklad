const scheduleData = {
  '': {
    'Monday': [
      ...
      { title: 'Stylizacja (28)', start: '10:45', end: '11:30' },
      { title: 'Stylizacja (28)', start: '11:40', end: '12:25' },
      { title: 'Fryzjer AL tech fr (int7)', start: '12:30', end: '13:15' },
      { title: 'Fryzjer AL tech fr (int7)', start: '13:45', end: '14:30' }
    ],

    'Tuesday': [
      { title: 'Język polski (M5)', start: '08:55', end: '09:40' },
      { title: 'Język polski (M5)', start: '09:50', end: '10:35' },
      { title: 'Biologia (207)', start: '10:45', end: '11:30' },
      { title: 'Matematyka (110)', start: '11:40', end: '12:25' },
      { title: 'Geografia (int7)', start: '12:30', end: '13:15' },
      { title: 'Wychowanie fizyczne (sg1)', start: '13:45', end: '14:30' },
      { title: 'Informatyka (214)', start: '14:35', end: '15:20' },
      { title: 'Informatyka (214)', start: '15:30', end: '16:15' }
    ],

    'Wednesday': [
      { title: 'Język rosyjski (215)', start: '09:50', end: '10:35' },
      { title: 'Język rosyjski (215)', start: '10:45', end: '11:30' },
      { title: 'Język polski (M5)', start: '11:40', end: '12:25' },
      { title: 'Język angielski (M3)', start: '12:30', end: '13:15' },
      { title: 'EDB (M4)', start: '13:45', end: '14:30' },
      { title: 'Geografia (int7)', start: '14:35', end: '15:20' },
      { title: 'Wychowanie fizyczne (sg4)', start: '15:30', end: '16:15' },
      { title: 'Wychowanie fizyczne (sg2)', start: '16:25', end: '17:10' }
    ],
    ...
    'Thursday': [
      ...
      { title: 'Język angielski (215)', start: '13:45', end: '14:30' },
      { title: 'Historia (8)', start: '14:35', end: '15:20' },
      { title: 'Biznes i zarządzanie (110)', start: '15:30', end: '16:15' }
    ],
