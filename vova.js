const scheduleData = {
  '': {
    'Monday': [
      { title: 'Język niemiecki |n (8)', start: '08:00', end: '08:45' },
      { title: 'Matematyka (209)', start: '08:55', end: '09:40' },
      { title: 'Język polski (116)', start: '09:50', end: '10:35' },
      { title: 'Laboratorium aplikacji (212)', start: '10:45', end: '11:30' },
      { title: 'Laboratorium aplikacji (212)', start: '11:40', end: '12:25' },
      { title: 'Laboratorium aplikacji (212)', start: '12:30', end: '13:15' },
      { title: 'Biologia (116)', start: '13:45', end: '14:30' },
      { title: 'Fizyka (120)', start: '14:35', end: '15:20' }
    ],

    'Tuesday': [
      { title: 'Matematyka (209)', start: '08:55', end: '09:40' },
      { title: 'Wychowanie fizyczne (sg2)', start: '09:50', end: '10:35' },
      { title: 'Wychowanie fizyczne (sg5)', start: '10:45', end: '11:30' },
      { title: 'Język polski (120)', start: '11:40', end: '12:25' },
      { title: 'Fizyka (120)', start: '12:30', end: '13:15' },
      { title: 'Biznes i zarządzanie (113)', start: '13:45', end: '14:30' },
      { title: 'Biznes i zarządzanie (113)', start: '14:35', end: '15:20' },
      { title: 'Projektowanie oprogramowania |2 (216)', start: '15:30', end: '16:15' }
    ],

    'Wednesday': [
      { title: 'Język niemiecki |n (6)', start: '08:00', end: '08:45' },
      { title: 'Historia (109)', start: '08:55', end: '09:40' },
      { title: 'Edukacja obywatelska (int 5)', start: '09:50', end: '10:35' },
      { title: 'Język angielski (106)', start: '10:45', end: '11:30' },
      { title: 'Matematyka (26)', start: '11:40', end: '12:25' },
      { title: 'Język angielski zawodowy (int 2)', start: '12:30', end: '13:15' },
      { title: 'Zajęcia z wychowawcą (MCI)', start: '13:45', end: '14:30' },
      { title: 'Wychowanie fizyczne (sg2)', start: '14:35', end: '15:20' },
      { title: 'Projektowanie oprogramowania |2 (216)', start: '15:30', end: '16:15' },
      { title: 'Projektowanie oprogramowania |2 (216)', start: '16:25', end: '17:10' }
    ],

    'Thursday': [
      { title: 'Język polski (4)', start: '10:45', end: '11:30' },
      { title: 'Język angielski (106)', start: '11:40', end: '12:25' },
      { title: 'Historia (109)', start: '12:30', end: '13:15' },
      { title: 'Biologia (207)', start: '13:45', end: '14:30' }
    ],

    'Friday': [
      { title: 'Informatyka (18)', start: '09:50', end: '10:35' },
      { title: 'Aplikacje desktopowe (212)', start: '10:45', end: '11:30' },
      { title: 'Aplikacje desktopowe (212)', start: '11:40', end: '12:25' },
      { title: 'Laboratorium aplikacji (212)', start: '12:30', end: '13:15' },
      { title: 'Laboratorium aplikacji (212)', start: '13:45', end: '14:30' },
      { title: 'Laboratorium baz danych |2 (208)', start: '14:35', end: '15:20' },
      { title: 'Laboratorium baz danych |2 (208)', start: '15:30', end: '16:15' }
    ]
  }
};
